  ...
  <FlowList :isNot="isNot" :finishedText="finishedText" :loading="loading" :finished="finished" @load-list-change="loadListChange">
    <List :listData="listData">
      <template #default="{ index }">
        <img v-if="index === 0" :class="$style.imgwrap" src="@/assets/new1.png" alt="">
        <img v-if="index === 1" :class="$style.imgwrap" src="@/assets/new2.png" alt="">
        <img v-if="index === 2" :class="$style.imgwrap" src="@/assets/new3.png" alt="">
      </template>
    </List>
  </FlowList>
</div>
